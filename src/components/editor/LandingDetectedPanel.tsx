...
export const LandingDetectedPanel: React.FC<LandingDetectedPanelProps> = ({
  ...
  return (
    <div className="w-full rounded-[20px] bg-[#131A3A]/90 backdrop-blur-2xl border border-white/15 p-4 shadow-[0_16px_40px_rgba(0,0,0,0.5),0_0_24px_rgba(79,124,255,0.15)] flex flex-col gap-3.5 select-none animate-in fade-in duration-200">
      ...
      <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-white/[0.08] text-xs">
        <span className="text-text-secondary font-semibold shrink-0">Framing:</span>
        <div className="flex items-center gap-1.5 bg-[#0A0B1E]/60 p-1 rounded-pill border border-white/10">
          {[
            { label: "Fit (0%)", value: 0 },
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-pill text-[11px] font-semibold transition-all cursor-pointer ${
