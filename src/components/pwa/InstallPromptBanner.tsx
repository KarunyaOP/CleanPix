...
import { Download, X, Sparkles, Smartphone, Share2 } from "lucide-react";
...
export const InstallPromptBanner: React.FC = () => {
  ...
  const handleInstallClick = async () => {
    ...
    // Trigger Android native install dialog
  ...
  // Don't show if already in standalone app mode, or dismissed, or on desktop without prompt
  ...
  return (
    <aside
      ...
      className="fixed bottom-4 inset-x-4 sm:left-auto sm:right-6 sm:bottom-6 sm:max-w-md z-50 p-4 rounded-[22px] bg-[#131A3A]/95 border border-primary/40 shadow-[0_16px_40px_rgba(0,0,0,0.7),0_0_24px_rgba(79,124,255,0.3)] backdrop-blur-2xl animate-in fade-in slide-in-from-bottom-4 duration-300 select-none"
    >
      <div className="flex items-start gap-3.5">
        {/* App Icon */}
        <div className="w-12 h-12 rounded-[14px] bg-gradient-to-tr from-primary to-secondary flex items-center justify-center text-white shrink-0 shadow-[0_0_16px_rgba(79,124,255,0.5)] p-1.5">
          <img
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex items-center gap-2">
            <button
              ...
              className="py-2 px-3.5 rounded-btn text-xs font-heading font-bold text-white bg-gradient-to-r from-primary to-secondary shadow-[0_0_16px_rgba(79,124,255,0.5)] hover:shadow-[0_0_24px_rgba(79,124,255,0.75)] active:scale-[0.98] transition-all flex items-center gap-1.5 cursor-pointer"
            >
              {isIos ? (
                <>
                  <Smartphone size={13} />
            ...
            <button
              ...
              className="py-2 px-3 rounded-btn text-xs font-semibold text-text-secondary hover:text-white transition-colors cursor-pointer"
            >
              Maybe Later
            </button>
          </div>
